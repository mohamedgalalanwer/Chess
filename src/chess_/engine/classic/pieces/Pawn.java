...
import chess_.engine.classic.board.Move.PawnAttackMove;
import chess_.engine.classic.board.Move.PawnEnPassantAttack;
import chess_.engine.classic.board.Move.PawnJump;
import chess_.engine.classic.board.Move.PawnMove;
import chess_.engine.classic.board.Move.PawnPromotion;
...
public final class Pawn
    ...
    public Pawn movePiece(final Move move) {
        return (Pawn) PieceUtils.INSTANCE.getMovedPawn(move);
    }
