...
//
//        final Board priorBoard = transitionMove.getToBoard();
//
//
//        return isThreatenedBoardImmediate(MoveUtils.exchangeScore(Move.priorBoard)) &&
//               !isThreatenedBoardImmediate(MoveUtils.exchangeScore(Move.priorBoard));
//    }
