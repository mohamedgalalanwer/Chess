...
import chess_.engine.classic.board.Move.MoveFactory;
import chess_.engine.classic.board.MoveTransition;
import chess_.engine.classic.board.MoveUtils;
...
import chess_.engine.classic.player.ai.AlphaBetaWithMoveOrdering;
import chess_.engine.classic.player.ai.StandardBoardEvaluator;
import chess_.pgn.FenUtilities;
import chess_.pgn.MySqlGamePersistence;
import static chess_.pgn.PGNUtilities.persistPGNFile;
import static chess_.pgn.PGNUtilities.writeGameToPGNFile;
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                chooser.setFileFilter(new javax.swing.filechooser.FileFilter() {
                    ...
                    public boolean accept(File f) {
                        return filesMenu.getName().toLowerCase().endsWith("pgn");
                    }
              //                     }
